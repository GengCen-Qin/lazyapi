...
func setupViewNavigationKeybindings(g *gocui.Gui) error {
	...
	if err := g.SetKeybinding("api_list", gocui.MouseLeft, gocui.ModNone, forms.MouseClick); err != nil {
	    return err
	}
	if err := g.SetKeybinding("record_list", gocui.MouseLeft, gocui.ModNone, forms.MouseClick); err != nil {
	    return err
	}
